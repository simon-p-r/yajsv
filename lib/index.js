...
internals.Manager.prototype.compile = function () {
    ...
    var self = this;
    var errs = {};
    this.registerFormats(internals.settings.formats);
...
internals.Manager.prototype.addSchemas = function (rawSchemas) {
    ...
    if (rawSchemas.constructor === Array) {
        ...
        // TODO validate object properties, could have 3 keys (collections, definitions and records)
