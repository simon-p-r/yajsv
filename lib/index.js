...
internals.Manager.prototype.build = function (schema) {
    ...
    if (type === 'record') {
        ...
        //TODO fix this?
        if (this.schemaSet.collections[subtype] || this.schemaSet.definitions[subtype]) {
            var toExtend = this.schemaSet.collections[subtype] ? this.schemaSet.collections[subtype].schema : this.schemaSet.definitions[subtype].schema;
